...
/home/akka/run-multinode-benchmark.sh "-Dtest=011-a -Dakka.remote.artery.advanced.idle-cpu-level=1 -Dakka.remote.default-remote-dispatcher.fork-join-executor.parallelism-min=4 -Dakka.remote.default-remote-dispatcher.fork-join-executor.parallelism-max=4 -Dakka.remote.artery.advanced.inbound-lanes=4" $TEST
/home/akka/run-multinode-benchmark.sh "-Dtest=011-b -Dakka.remote.artery.advanced.idle-cpu-level=1 -Dakka.remote.default-remote-dispatcher.fork-join-executor.parallelism-min=4 -Dakka.remote.default-remote-dispatcher.fork-join-executor.parallelism-max=4 -Dakka.remote.artery.advanced.inbound-lanes=4" $TEST
